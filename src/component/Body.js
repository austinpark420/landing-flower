          ...
          <Col lg="6" className="body-description">
            ...
            <div className="body-description-detail">
              <ListGroup className="body-description-detail-inner">
                <ListGroupItem>도매시장 직배송으로 최상의 싱싱함</ListGroupItem>
                <ListGroupItem>기존 온라인/꽃집과 비교하여 2배 이상의 풍성함</ListGroupItem>
            ...
            <ListGroup className="body-description-caution">
              <ListGroupItem>현재 서울지역만 주문을 받고 있습니다.</ListGroupItem>
              <ListGroupItem>수도권 지역은 별도로 연락 주시기 바랍니다.</ListGroupItem>
              <ListGroupItem>배송 24시간 전에는 주문이 필요합니다.</ListGroupItem>
            </ListGroup>
